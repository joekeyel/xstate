const noInternet = {
  ...
  function cpeDiagnosis({ cpe, leds = {} }) {
    const { power, wan, pon, los,link, auth, lan1,dsl,internet,twodotfourghz,fiveghz,wlan,wirelesstwodotfourghz,wirelessfiveghz } = leds
    switch (cpe) {
      case 'FIBERHOME_AN5506_04B5G':
        ...
        case 'NETIS_DL4480V': 
            ...
            if (power === 'green') {
                ...
                if(dsl === 'green' &&  internet === 'any'  &&  wlan === 'blueBlinking' ) return 'cpeIssue'
